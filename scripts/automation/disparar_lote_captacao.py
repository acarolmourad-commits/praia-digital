#!/usr/bin/env python3
"""
disparar_lote_captacao.py
Prepara o pacote de disparo do lote de captação digital.
Gera:
 - CSV Brevo-compatível
 - CSV WhatsApp-compatível
 - Checklist de envio

Uso: python scripts/automation/disparar_lote_captacao.py
"""
import csv
...
BREVO_OUT = FOLDER / f'para-brevo-captacao-{TODAY}.csv'
WA_OUT = FOLDER / f'para-whatsapp-captacao-{TODAY}.csv'
CHECK_OUT = BASE / 'docs' / 'sales' / f'checklist-envio-captacao-{TODAY}.txt'
...
with CHECK_OUT.open('w', encoding='utf-8') as f:
    f.write(f'Checklist de envio — Captação Digital — {TODAY}\n')
    f.write('='*60 + '\n')
