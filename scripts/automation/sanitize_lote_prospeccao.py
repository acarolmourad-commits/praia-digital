#!/usr/bin/env python3
"""
sanitize_lote_prospeccao.py
Audita e prepara o lote B2B de prospeccao para imobiliárias.
Uso: python scripts/automation/sanitize_lote_prospeccao.py
"""
...
ENTRADA = BASE / "docs/sales/csv-lotes-b2b/lote-b2b-prospeccao-2026-07-22.csv"
SAIDA = BASE / "docs/sales/csv-lotes-b2b/lote-b2b-prospeccao-sanitizado-2026-07-22.csv"
...
def main():
    ...
    print(f"Sanitizado prospeccao: {len(rows)} -> {len(sane)} leads")
