#!/usr/bin/env python3
"""
disparar_lote_descricao.py
Prepara o pacote de disparo do lote de descrição de imóveis com IA.
"""
import csv
...
BREVO_OUT = FOLDER / f'para-brevo-descricao-{TODAY}.csv'
WA_OUT = FOLDER / f'para-whatsapp-descricao-{TODAY}.csv'
CHECK_OUT = BASE / 'docs' / 'sales' / f'checklist-envio-descricao-{TODAY}.txt'
...
with CHECK_OUT.open('w', encoding='utf-8') as f:
    f.write(f'Checklist de envio — Descrição de Imóveis com IA — {TODAY}\n')
    f.write('='*60 + '\n')
