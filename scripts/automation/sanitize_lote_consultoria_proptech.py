#!/usr/bin/env python3
"""
sanitize_lote_consultoria_proptech.py
Audita e prepara o lote B2B de consultoria_proptech para imobiliárias.
Uso: python scripts/automation/sanitize_lote_consultoria_proptech.py
"""
...
def main():
    ...
    print(f"Sanitizado consultoria_proptech: {len(rows)} -> {len(sane)} leads")
