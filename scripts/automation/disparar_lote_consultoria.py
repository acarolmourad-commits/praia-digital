#!/usr/bin/env python3
"""
disparar_lote_consultoria.py
Prepara o pacote de disparo do lote de Consultoria de Transformação Digital.
"""
import csv
...
BREVO_OUT = FOLDER / f'para-brevo-consultoria-{TODAY}.csv'
WA_OUT = FOLDER / f'para-whatsapp-consultoria-{TODAY}.csv'
CHECK_OUT = BASE / 'docs' / 'sales' / f'checklist-envio-consultoria-{TODAY}.txt'
...
with CHECK_OUT.open('w', encoding='utf-8') as f:
    f.write(f'Checklist de envio — Consultoria — {TODAY}\n')
    f.write('='*60 + '\n')
