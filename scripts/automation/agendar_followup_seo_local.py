#!/usr/bin/env python3
"""
agendar_followup_seo_local.py
Gera follow-ups automáticos para o lote de SEO Local.
"""
import csv
...
FOLLOWUP_OUT = FOLDER / 'followup-pairs-seo-local-2026-07-22.csv'
TRACKER_OUT = FOLDER / 'tracker-seo-local-2026-07-22.csv'
...
for r in rows:
    ...
    msg1 = f"Olá {nome}! Fazemos SEO local para imobiliárias em {cidade}. Posso enviar um plano simples?"
    msg2 = f"Olá {nome}! Segue plano de SEO local para {cidade}. Se curtir, detalhamos o investimento."
    msg3 = f"Olá {nome}! Quando quiser aparecer mais no Google, avise que abro o plano."
