...
for p in sorted(base.glob('*.html')):
    ...
    txt = txt.replace('Venda Imovel em Praia | Praia Digital', title)
    txt = txt.replace('Venda Imovel em Sao | Praia Digital', title)
    txt = txt.replace('Venda Imovel em Guaruja | Praia Digital', title)
    txt = txt.replace('Venda Imovel em Santos | Praia Digital', title)
    txt = txt.replace('Venda Imovel em Bertioga | Praia Digital', title)
    txt = txt.replace('Venda Imovel em Itanhaem | Praia Digital', title)
    txt = txt.replace('Venda Imovel em Mongagua | Praia Digital', title)
    txt = txt.replace('Venda Imovel em Peruibe | Praia Digital', title)
    txt = txt.replace('Venda Imovel em Caraguatatuba | Praia Digital', title)
    txt = txt.replace('Venda Imovel em Ilhabela | Praia Digital', title)
    txt = txt.replace('Venda Imovel em Sao Sebastiao | Praia Digital', title)
    txt = txt.replace('Venda Imovel em Ubatuba | Praia Digital', title)
    txt = txt.replace('Captacao de Imoveis em Guaruja | Praia Digital', title)
    txt = txt.replace('Captacao de Imoveis em Santos | Praia Digital', title)
    txt = txt.replace('Captacao de Imoveis em Bertioga | Praia Digital', title)
    txt = txt.replace('Avaliacao de Imoveis em Guaruja | Praia Digital', title)
    txt = txt.replace('Avaliacao de Imoveis em Santos | Praia Digital', title)
    txt = txt.replace('Avaliacao de Imoveis em Bertioga | Praia Digital', title)
    txt = txt.replace('Consultoria Imobiliaria em Guaruja | Praia Digital', title)
    txt = txt.replace('Consultoria Imobiliaria em Santos | Praia Digital', title)
    txt = txt.replace('Consultoria Imobiliaria em Bertioga | Praia Digital', title)
    txt = txt.replace('Descricao com IA em Guaruja | Praia Digital', title)
    txt = txt.replace('Descricao com IA em Santos | Praia Digital', title)
    txt = txt.replace('Descricao com IA em Bertioga | Praia Digital', title)
    txt = txt.replace('Automacao Imobiliaria em Guaruja | Praia Digital', title)
    txt = txt.replace('Automacao Imobiliaria em Santos | Praia Digital', title)
    txt = txt.replace('Automacao Imobiliaria em Bertioga | Praia Digital', title)
