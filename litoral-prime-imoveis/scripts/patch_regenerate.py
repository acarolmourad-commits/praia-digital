...
# Find last item end position using brace counting from last item start
...
last_item_end = i + 1
print('LAST_ITEM_ENDS_AT', last_item_end)
print('AFTER_LAST_ITEM:', repr(text[last_item_end:last_item_end+60]))
...
new_text = text[:last_item_end] + new_items + text[last_item_end:]
