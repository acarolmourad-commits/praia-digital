# MANIFESTO DO CURSO — Recuperação de Vendas para Corretores
...
Recuperação de Vendas para Corretores
...
- Aula 1.1: O que é recuperação de vendas
- Aula 1.2: Perfil do profissional
- Aula 1.3: Método e metas
- Aula 2.1: Análise
- Aula 2.2: Comunicação
- Aula 2.3: Follow-up
- Aula 3.1: Reversão
- Aula 3.2: Negociação
- Aula 3.3: Fechamento
