...
## Introdução
Entenda o contexto, o seu perfil e as métricas essenciais para financiamento, entrada, FGTS e condições de compra.
...
## Prompt de IA
"Atue como especialista em financiamento, entrada, FGTS e condições de compra. Faça um diagnóstico com base nestas respostas: [insira suas respostas]."
