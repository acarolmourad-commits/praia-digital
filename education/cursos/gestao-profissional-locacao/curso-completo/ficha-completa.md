...
## Público-alvo
- Proprietários que querem administrar seus próprios imóveis
- Investidores com múltiplos imóveis
- Corretores e imobiliárias que querem profissionalizar a gestão
- Interesse: gestão, imóveis, aluguel, administração, ROI

## Pré-requisitos
Nenhum. Curso completo do zero à operação profissional.
